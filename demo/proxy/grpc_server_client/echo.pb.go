...
var fileDescriptor_08134aea513e0001 = []byte{
	...
	0x1e, 0x88, 0xc2, 0xe2, 0x82, 0xfc, 0xbc, 0xe2, 0x54, 0xdc, 0x2a, 0x8d, 0x3a, 0x98, 0xb8, 0x58,
	...
	0x72, 0xe3, 0x12, 0x77, 0xca, 0x4c, 0xc9, 0x2c, 0x4a, 0x4d, 0x2e, 0xc9, 0xcc, 0xcf, 0x4b, 0xcc,
	0x81, 0x18, 0x44, 0xa2, 0x29, 0x06, 0x8c, 0x4e, 0x9c, 0x51, 0xec, 0x7a, 0xd6, 0xe0, 0xe0, 0x4e,
	0x62, 0x03, 0x53, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x95, 0x10, 0x2d, 0x59, 0x83, 0x01,
	0x00, 0x00,
}
...
func (c *echoClient) BidirectionalStreamEcho(ctx context.Context, opts ...grpc.CallOption) (Echo_BidirectionalStreamEchoClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Echo_serviceDesc.Streams[2], "/echo.Echo/BidirectionalStreamEcho", opts...)
	if err != nil {
		return nil, err
	}
...
func (*UnimplementedEchoServer) BidirectionalStreamEcho(srv Echo_BidirectionalStreamEchoServer) error {
